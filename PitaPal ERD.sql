...
ALTER TABLE category ADD FOREIGN KEY (id) REFERENCES menu_item (category_id);
...
ALTER TABLE pending_menu_item ADD FOREIGN KEY (id) REFERENCES pending_condiments (id);
